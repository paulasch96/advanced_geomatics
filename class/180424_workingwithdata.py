...
#cleanup
HMap.remove_layers_by_name(['OpenStreetMap', citiesName]) #otherwise there would be many layers, as we run it each time and create new layers...name from layerspanel
