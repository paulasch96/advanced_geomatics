...
#cleanup
HMap.remove_layers_by_name(['OpenStreetMap', citiesName, countriesNames ,"rivers_italy"]) #otherwise there would be many layers, as we run it each time and create new layers...name from layerspanel
...
mapProperties = {
    "x": 5, #x ynd y give you the position on the whole paper. in mm
    "y": 25,
...
labelProperties = {
    "x": 120,
    "y": 10,
    "text": "Nice map of northern italy",
    "font_size": 28,
    "bold": True,
    "italic": False
}
...
legendProperties = {
    ...
    "width": 150,
    "height": 100,
    "max_symbol_size": 100  #not inmm, play around 
